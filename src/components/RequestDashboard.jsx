...
export default function RequestDashboard() {
  ...
  if (loading) {
    return <div className="bg-white rounded-3xl p-6 shadow-lg">Loading dashboard...</div>;
  }

  return (
    <div className="space-y-6">
      <div className="grid md:grid-cols-4 gap-4">
        <StatCard title="Total Requests" value={stats.total} color="from-blue-500 to-cyan-500" />
        <StatCard title="Pending" value={stats.pending} color="from-amber-500 to-orange-500" />
        <StatCard title="Approved" value={stats.approved} color="from-emerald-500 to-green-500" />
        <StatCard title="Fulfilled" value={stats.fulfilled} color="from-teal-500 to-emerald-500" />
      </div>
